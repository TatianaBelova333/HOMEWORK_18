...
class Movie(db.Model):
    ...
    genre_id = db.Column(db.Integer, db.ForeignKey("genre.id", ondelete='SET NULL'), nullable=True)
    genre = db.relationship("Genre")
    director_id = db.Column(db.Integer, db.ForeignKey("director.id", ondelete='SET NULL'), nullable=True)
